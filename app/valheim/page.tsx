...
const plans = [
  { name: 'Starter', price: '4.99', ram: '4 GB', cpu: '2 vCores', storage: '50 GB NVMe', slots: 'Ilimitados', pid: '70' },
  { name: 'Advanced', price: '9.99', ram: '8 GB', cpu: '3 vCores', storage: '80 GB NVMe', slots: 'Ilimitados', pid: '71', popular: true },
  { name: 'Pro', price: '16.99', ram: '12 GB', cpu: '4 vCores', storage: '120 GB NVMe', slots: 'Ilimitados', pid: '72' },
  { name: 'Extreme', price: '24.99', ram: '16 GB', cpu: '6 vCores', storage: '200 GB NVMe', slots: 'Ilimitados', pid: '73' },
];
...
const features = [
  ...
  { icon: '⚡', title: 'Instalación Instantánea', desc: 'Tu servidor de Valheim estará en línea segundos después de tu pago.' },
  ...
  return (
    <>
      ...
      <GameHostingTemplate 
        gameName="Valheim"
        gameId="valheim"
        bgImage="/assets/games/valheim.jpeg"
        description="Conquista el décimo mundo nórdico. Servidores dedicados 24/7 para ti y tus vikingos."
        plans={plans}
        features={features}
      />
    </>
