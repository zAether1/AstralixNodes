  ...
  return (
    <div className="min-h-screen bg-[#020202]">
      ...
      <main>
        ...
        <section ref={heroRef} className="relative bg-[#180228] overflow-hidden min-h-[50vh] flex items-center pt-20 border-b border-white/5">
          <div className="absolute inset-0">
            <div className="absolute inset-0 bg-gradient-to-b from-[#020202]/90 via-[#180228]/80 to-[#020202] z-10"></div>
          ...
          <div className="relative z-20 max-w-[87.5rem] mx-auto px-6 py-20 text-center w-full">
            <span className="hero-anim inline-block py-1.5 px-3 rounded-full bg-[#64189D]/20 text-[#64189D] border border-[#64189D]/30 font-bold text-xs tracking-widest uppercase mb-4 shadow-[0_0_15px_rgba(100,24,157,0.3)]">Game Hosting Premium</span>
            <h1 className="hero-anim text-4xl sm:text-5xl md:text-6xl font-black text-white uppercase leading-[1.1] mb-6 tracking-tight">
              HOSTING PARA <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-[#64189D]">TUS JUEGOS</span>
            </h1>
            ...
            <div ref={gridRef} className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
              {games.map((game, i) => (
                <Link key={i} href={`/${game.id}`} className="game-card group block bg-[#10011c] rounded-xl overflow-hidden border border-[#64189D]/10 hover:border-[#64189D]/50 transition-all duration-300 hover:shadow-[0_8px_30px_rgba(100,24,157,0.15)] hover:-translate-y-1 relative">
                  <div className="absolute top-3 right-3 z-10 bg-black/60 backdrop-blur-md text-white text-[0.65rem] font-bold uppercase tracking-wider px-2 py-1 rounded border border-white/10">
                    {game.tag}
                  </div>
