        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 mb-12">
          ...
          <div className="lg:max-w-[26.25rem] flex-shrink-0">
            ...
            <div className="flex items-center gap-4 mt-6">
              <a href="#" className="text-[#888] hover:text-white transition-colors cursor-default" aria-label="X (Twitter)">
              ...
              <a href="#" className="text-[#888] hover:text-white transition-colors cursor-default" aria-label="Instagram">
              ...
              <a href="#" className="text-[#888] hover:text-white transition-colors cursor-default" aria-label="Facebook">
                <svg className="w-[18px] h-[18px]" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"></path></svg>
              </a>
              <a target="_blank" rel="noopener noreferrer" className="text-[#888] hover:text-white transition-colors" aria-label="Discord" href="https://discord.gg/zmc2VbFCCp">
              ...
              <a href="#" className="text-[#888] hover:text-white transition-colors cursor-default" aria-label="YouTube">
              ...
              <a href="#" className="text-[#888] hover:text-white transition-colors cursor-default" aria-label="TikTok">
          ...
          <div className="flex-1 grid grid-cols-2 md:grid-cols-3 gap-8 lg:gap-12 relative">
            <div className="min-w-0 break-words">
              ...
              <ul className="space-y-2.5">
                ...
                <li><Link className="text-[#888] hover:text-white text-sm transition-colors" href="/minecraft-dedicado">Servidor Dedicado</Link></li>
            ...
            <div className="col-span-2 md:col-span-1 text-center md:text-left min-w-0 break-words">
              ...
              <ul className="space-y-2.5">
                ...
                <li><a target="_blank" rel="noopener noreferrer" className="text-[#888] hover:text-white text-sm transition-colors" href="https://discord.gg/zmc2VbFCCp">Discord</a></li>
