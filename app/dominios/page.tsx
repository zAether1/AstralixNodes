...
export const metadata: Metadata = {
  title: 'Registrar un Dominio | AstralixNodes',
  description: 'Encuentra y registra el nombre de dominio perfecto para tu proyecto. Gestión DNS avanzada, protección WHOIS gratuita y activación instantánea.',
  openGraph: {
    title: 'Registrar un Dominio | AstralixNodes',
    description: 'Encuentra y registra el nombre de dominio perfecto para tu proyecto. Gestión DNS avanzada, protección WHOIS gratuita y activación instantánea.',
    url: 'https://astralixnodes.com/dominios',
    siteName: 'AstralixNodes',
    images: [{ url: '/assets/services/dominios-bg.png', width: 1200, height: 630 }],
    locale: 'es_ES',
    type: 'website',
  }
};
...
const plans = [
  { name: 'Básico', price: '4.99', features: ['1 vCore CPU', '2 GB RAM', '30 GB NVMe Storage', '1 IPv4 Dedicada', '1 Gbps de red'], pid: '100' },
  { name: 'Estándar', price: '9.99', features: ['2 vCore CPU', '4 GB RAM', '60 GB NVMe Storage', '1 IPv4 Dedicada', '1 Gbps de red'], pid: '101', popular: true },
  { name: 'Avanzado', price: '18.99', features: ['4 vCore CPU', '8 GB RAM', '120 GB NVMe Storage', '1 IPv4 Dedicada', '1 Gbps de red'], pid: '102' },
  { name: 'Empresarial', price: '34.99', features: ['8 vCore CPU', '16 GB RAM', '250 GB NVMe Storage', '1 IPv4 Dedicada', '1 Gbps de red'], pid: '103' },
];
...
export default function CloudPage() {
  return (
    <CloudHostingTemplate 
      ...
      bgImage="/assets/services/dominios-bg.png"
      description="Encuentra y registra el nombre de dominio perfecto para tu proyecto. Gestión DNS avanzada, protección WHOIS gratuita y activación instantánea."
      plans={plans}
      benefits={benefits}
    />
