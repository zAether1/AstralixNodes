...
export const metadata: Metadata = {
  title: 'VPS Hosting Premium | AstralixNodes',
  description: 'Servidores Virtuales Privados de altísimo rendimiento. Almacenamiento NVMe puro y virtualización KVM para máximo control y velocidad.',
  openGraph: {
    title: 'VPS Hosting Premium | AstralixNodes',
    description: 'Servidores Virtuales Privados de altísimo rendimiento. Almacenamiento NVMe puro y virtualización KVM para máximo control y velocidad.',
    url: 'https://astralixnodes.com/vps',
    siteName: 'AstralixNodes',
    images: [{ url: '/assets/services/vps-bg.png', width: 1200, height: 630 }],
    locale: 'es_ES',
    type: 'website',
  }
};
...
const plans = [
  { name: 'Básico', price: '4.99', features: ['1 vCore CPU', '2 GB RAM', '30 GB NVMe Storage', '1 IPv4 Dedicada', '1 Gbps de red'], pid: '90' },
  { name: 'Estándar', price: '9.99', features: ['2 vCore CPU', '4 GB RAM', '60 GB NVMe Storage', '1 IPv4 Dedicada', '1 Gbps de red'], pid: '91', popular: true },
  { name: 'Avanzado', price: '18.99', features: ['4 vCore CPU', '8 GB RAM', '120 GB NVMe Storage', '1 IPv4 Dedicada', '1 Gbps de red'], pid: '92' },
  { name: 'Empresarial', price: '34.99', features: ['8 vCore CPU', '16 GB RAM', '250 GB NVMe Storage', '1 IPv4 Dedicada', '1 Gbps de red'], pid: '93' },
];
...
export default function CloudPage() {
  return (
    <CloudHostingTemplate 
      ...
      bgImage="/assets/services/vps-bg.png"
      description="Servidores Virtuales Privados de altísimo rendimiento. Almacenamiento NVMe puro y virtualización KVM para máximo control y velocidad."
      plans={plans}
      benefits={benefits}
    />
